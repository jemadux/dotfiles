#This is some basically coomans from gsettings that
#I want to be availbe . 
alias gset-c-vm='gsettings reset org.virt-manager.virt-manager.urls isos'
alias gset-rd-off='gsettings set org.gnome.desktop.privacy remember-recent-files false'
